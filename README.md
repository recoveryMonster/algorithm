...
这里创建一个类来表示栈。详细代码可见 [stack-array.mjs](https://github.com/recoveryMonster/algorithm/tree/master/JS-datastructrues/src/js/data-structures/stack-array.mjs) 文件。首先声明 Stack 类开始。
...
首先创建一个 Stack 类（ [stack.mjs 文件](https://github.com/recoveryMonster/algorithm/tree/master/JS-datastructrues/src/js/data-structures/stack.mjs)）。这里使用 count 属性来帮助我们记录栈的大小，以及添加和删除元素。
...
- [循环队列-击鼓传花游戏](https://github.com/recoveryMonster/algorithm/tree/master/JS-datastructrues/examples/Queue/hotPotato.mjs)
- [回文检查器](https://github.com/recoveryMonster/algorithm/tree/master/JS-datastructrues/examples/Queue/palindromeChecker.mjs)
